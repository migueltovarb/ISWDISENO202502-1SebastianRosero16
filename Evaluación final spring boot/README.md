...
try {
    $test = Invoke-RestMethod -Uri "http://localhost:8081/api/vehicles" -Method GET
...
$created = Invoke-RestMethod -Uri "http://localhost:8081/api/vehicles" -Method POST -Body $vehicle -ContentType "application/json"
...
Write-Host "───────────────────────────────────────────────────────" -ForegroundColor DarkGray
$all = Invoke-RestMethod -Uri "http://localhost:8081/api/vehicles" -Method GET
...
Write-Host "───────────────────────────────────────────────────────" -ForegroundColor DarkGray
$one = Invoke-RestMethod -Uri "http://localhost:8081/api/vehicles/$vehicleId" -Method GET
...
$result = Invoke-RestMethod -Uri "http://localhost:8081/api/vehicles/$vehicleId" -Method PUT -Body ([System.Text.Encoding]::UTF8.GetBytes($updated)) -ContentType "application/json; charset=utf-8"
...
Write-Host "───────────────────────────────────────────────────────" -ForegroundColor DarkGray
Invoke-RestMethod -Uri "http://localhost:8081/api/vehicles/$vehicleId" -Method DELETE
...
Write-Host "───────────────────────────────────────────────────────" -ForegroundColor DarkGray
try {
    $deleted = Invoke-RestMethod -Uri "http://localhost:8081/api/vehicles/$vehicleId" -Method GET -ErrorAction Stop
...
Write-Host "───────────────────────────────────────────────────────" -ForegroundColor DarkGray
$byPlate = Invoke-RestMethod -Uri "http://localhost:8081/api/vehicles/license/XYZ-111" -Method GET -ErrorAction SilentlyContinue
if ($byPlate) {
...
Write-Host "───────────────────────────────────────────────────────" -ForegroundColor DarkGray
$byBrand = Invoke-RestMethod -Uri "http://localhost:8081/api/vehicles/brand/Toyota" -Method GET
...
Write-Host "───────────────────────────────────────────────────────" -ForegroundColor DarkGray
$byYear = Invoke-RestMethod -Uri "http://localhost:8081/api/vehicles/year/2023" -Method GET
...
Write-Host "═══════════════════════════════════════════════════════`n" -ForegroundColor Cyan
$finalVehicles = Invoke-RestMethod -Uri "http://localhost:8081/api/vehicles" -Method GET
...
```bash
curl http://localhost:8081/api/vehicles/{PEGA_EL_ID_AQUI}
```
**Resultado esperado:** JSON con el vehículo específico

**Paso 4: Actualizar el vehículo (UPDATE)**
```bash
curl -X PUT http://localhost:8081/api/vehicles/{PEGA_EL_ID_AQUI} \
  -H "Content-Type: application/json" \
  -d '{
    "brand": "Toyota",
    "model": "Corolla",
...
```bash
curl -X DELETE http://localhost:8081/api/vehicles/{PEGA_EL_ID_AQUI}
```
...
$vehicles = Invoke-RestMethod -Uri "http://localhost:8081/api/vehicles" -Method GET
...
Write-Host "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" -ForegroundColor DarkGray
try {
    $response = Invoke-WebRequest -Uri "http://localhost:8081/api/vehicles" -Method GET -UseBasicParsing -ErrorAction Stop
    Write-Host "✅ Aplicación está corriendo en puerto 8081`n" -ForegroundColor Green
} catch {
...
$created = Invoke-RestMethod -Uri "http://localhost:8081/api/vehicles" -Method POST -Body $body -ContentType "application/json"
Write-Host "✅ Vehículo creado con ID: $($created.id)" -ForegroundColor Green
$vehicleId = $created.id
Write-Host ""
...
$updated = Invoke-RestMethod -Uri "http://localhost:8081/api/vehicles/$vehicleId" -Method PUT -Body ([System.Text.Encoding]::UTF8.GetBytes($updateBody)) -ContentType "application/json; charset=utf-8"
...
try {
    Invoke-RestMethod -Uri "http://localhost:8081/api/vehicles/$vehicleId" -Method GET -ErrorAction Stop
...
Write-Host "✅ Spring Boot iniciado en puerto 8081" -ForegroundColor Green
